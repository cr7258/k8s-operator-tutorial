...
import (
	...
	json "encoding/json"
	"fmt"
	v1alpha1 "kluster/pkg/apis/viveksingh.dev/v1alpha1"
	viveksinghdevv1alpha1 "kluster/pkg/client/applyconfiguration/viveksingh.dev/v1alpha1"
...
type KlusterInterface interface {
	...
	Apply(ctx context.Context, kluster *viveksinghdevv1alpha1.KlusterApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Kluster, err error)
	KlusterExpansion
}
...
func (c *klusters) Apply(ctx context.Context, kluster *viveksinghdevv1alpha1.KlusterApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Kluster, err error) {
	if kluster == nil {
