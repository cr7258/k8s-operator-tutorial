...
func (c *FakeKlusters) Apply(ctx context.Context, kluster *viveksinghdevv1alpha1.KlusterApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Kluster, err error) {
	if kluster == nil {
